        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <br>
                    <p class="text-xl penjelasan text-teal-600">Teknik : <span class="text-teal-100">HTML
                            Injection</span></p>
                    <p class="text-xl penjelasan text-teal-600">Petunjuk : <span class="text-teal-100">berlin &
                            berlin123</span></p>
                </div>
            </div>
        </div>
